...
public class Analysis {
	 ...
	 * 
	 */
	// TODO: esto ser�a mucho m�s r�pido si ley�ramos la matriz directamente,
	// no???
	public void loadMatrix(String label) {
		if (microarrayData != null) {
			synchronized (this) {
				...
				// modificaci�n para que funcione en windows
				...
				// R necesita las barras de direcci�n duplicadas, y la forma de
				// hacerlo es �sta
				...
				// hasta aqu� la modificaci�n para que funcione en windows
