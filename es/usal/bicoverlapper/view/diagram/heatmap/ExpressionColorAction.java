...
/**
 * <p>
	Modification of DataColorAction to accept a color range different from the range
	of colored items
	This is necessary to color a sparse microarray heatmap coherent to the total heatmap values
	
 * </p>
 * 
 * 
 * @author <a href="http://carpex.usal.es/~visusal/rodrigo/">rodrigo santamaría</a>
 */
public class ExpressionColorAction extends ColorAction {
     ...
     */
    public ExpressionColorAction(String group, String dataField, 
    ...
    protected void setup() {
        ...
        case Constants.ORDINAL:
            ...
            if(m_min<m_max)
            	{
            	m_cmap.setMinValue(m_min);
	            m_cmap.setMaxValue(m_max);
	            }
            else
	            {
    ...
    public int getColor(VisualItem item) {
        ...
        default:
            ...
            Integer idx = (Integer)m_omap.get(item.get(m_dataField));//TODO: error aqui al reseleccionar
        	if(idx==null)
        		System.out.println("idx es null para "+item.getDouble(m_dataField));
