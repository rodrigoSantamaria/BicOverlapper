/**
 * BiostrucHistory_replacedByType.java
 *
...
public class BiostrucHistory_replacedByType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiostrucReplaceType biostrucReplace;

    public BiostrucHistory_replacedByType() {
    }
    ...
    /**
     * Gets the biostrucReplace value for this BiostrucHistory_replacedByType.
     * 
    ...
    /**
     * Sets the biostrucReplace value for this BiostrucHistory_replacedByType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucHistory_replacedByType)) return false;
        BiostrucHistory_replacedByType other = (BiostrucHistory_replacedByType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucHistory_replacedByType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-history_replaced-byType"));
