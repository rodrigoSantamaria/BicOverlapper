/**
 * SeqSubmit_data_deleteType.java
 *
...
public class SeqSubmit_data_deleteType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public SeqSubmit_data_deleteType() {
    }
    ...
    /**
     * Gets the seqId value for this SeqSubmit_data_deleteType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this SeqSubmit_data_deleteType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqSubmit_data_deleteType)) return false;
        SeqSubmit_data_deleteType other = (SeqSubmit_data_deleteType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqSubmit_data_deleteType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-submit_data_deleteType"));
