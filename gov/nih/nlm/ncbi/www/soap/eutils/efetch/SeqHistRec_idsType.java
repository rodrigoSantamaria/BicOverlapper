...
public class SeqHistRec_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public SeqHistRec_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this SeqHistRec_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this SeqHistRec_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqHistRec_idsType)) return false;
        SeqHistRec_idsType other = (SeqHistRec_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqHistRec_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-hist-rec_idsType"));
