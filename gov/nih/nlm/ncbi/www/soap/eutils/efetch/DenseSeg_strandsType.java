...
public class DenseSeg_strandsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.NaStrandType[] naStrand;

    public DenseSeg_strandsType() {
    }
    ...
    /**
     * Gets the naStrand value for this DenseSeg_strandsType.
     * 
     * @return naStrand
     */
    ...
    /**
     * Sets the naStrand value for this DenseSeg_strandsType.
     * 
     * @param naStrand
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DenseSeg_strandsType)) return false;
        DenseSeg_strandsType other = (DenseSeg_strandsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DenseSeg_strandsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Dense-seg_strandsType"));
