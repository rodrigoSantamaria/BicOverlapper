/**
 * BiostrucAlign_alignmentsType.java
 *
...
public class BiostrucAlign_alignmentsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiostrucAnnotSetType biostrucAnnotSet;

    public BiostrucAlign_alignmentsType() {
    }
    ...
    /**
     * Gets the biostrucAnnotSet value for this BiostrucAlign_alignmentsType.
     * 
    ...
    /**
     * Sets the biostrucAnnotSet value for this BiostrucAlign_alignmentsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucAlign_alignmentsType)) return false;
        BiostrucAlign_alignmentsType other = (BiostrucAlign_alignmentsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucAlign_alignmentsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-align_alignmentsType"));
