/**
 * ID2SSeqDescrInfo_bioseqsType.java
 *
...
public class ID2SSeqDescrInfo_bioseqsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SBioseqIdsType ID2SBioseqIds;

    public ID2SSeqDescrInfo_bioseqsType() {
    }
    ...
    /**
     * Gets the ID2SBioseqIds value for this ID2SSeqDescrInfo_bioseqsType.
     * 
    ...
    /**
     * Sets the ID2SBioseqIds value for this ID2SSeqDescrInfo_bioseqsType.
     * 
     * @param ID2SBioseqIds
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqDescrInfo_bioseqsType)) return false;
        ID2SSeqDescrInfo_bioseqsType other = (ID2SSeqDescrInfo_bioseqsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqDescrInfo_bioseqsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-descr-Info_bioseqsType"));
