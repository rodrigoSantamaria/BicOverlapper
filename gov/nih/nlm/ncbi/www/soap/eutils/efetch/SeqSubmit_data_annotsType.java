/**
 * SeqSubmit_data_annotsType.java
 *
...
public class SeqSubmit_data_annotsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqAnnotType[] seqAnnot;

    public SeqSubmit_data_annotsType() {
    }
    ...
    /**
     * Gets the seqAnnot value for this SeqSubmit_data_annotsType.
     * 
     * @return seqAnnot
     */
    ...
    /**
     * Sets the seqAnnot value for this SeqSubmit_data_annotsType.
     * 
     * @param seqAnnot
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqSubmit_data_annotsType)) return false;
        SeqSubmit_data_annotsType other = (SeqSubmit_data_annotsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqSubmit_data_annotsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-submit_data_annotsType"));
