/**
 * OrgName_name_namedhybridType.java
 *
...
public class OrgName_name_namedhybridType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BinomialOrgNameType binomialOrgName;

    public OrgName_name_namedhybridType() {
    }
    ...
    /**
     * Gets the binomialOrgName value for this OrgName_name_namedhybridType.
     * 
    ...
    /**
     * Sets the binomialOrgName value for this OrgName_name_namedhybridType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OrgName_name_namedhybridType)) return false;
        OrgName_name_namedhybridType other = (OrgName_name_namedhybridType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OrgName_name_namedhybridType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "OrgName_name_namedhybridType"));
