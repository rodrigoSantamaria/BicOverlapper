/**
 * BiostrucResidueGraphSet_residueGraphsType.java
 *
...
public class BiostrucResidueGraphSet_residueGraphsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ResidueGraphType[] residueGraph;

    public BiostrucResidueGraphSet_residueGraphsType() {
    }
    ...
    /**
     * Gets the residueGraph value for this BiostrucResidueGraphSet_residueGraphsType.
     * 
     * @return residueGraph
     */
    ...
    /**
     * Sets the residueGraph value for this BiostrucResidueGraphSet_residueGraphsType.
     * 
     * @param residueGraph
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucResidueGraphSet_residueGraphsType)) return false;
        BiostrucResidueGraphSet_residueGraphsType other = (BiostrucResidueGraphSet_residueGraphsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucResidueGraphSet_residueGraphsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-residue-graph-set_residue-graphsType"));
