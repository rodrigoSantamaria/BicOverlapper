...
public class SeqLocEquivType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqLocType[] seqLoc;

    public SeqLocEquivType() {
    }
    ...
    /**
     * Gets the seqLoc value for this SeqLocEquivType.
     * 
     * @return seqLoc
     */
    ...
    /**
     * Sets the seqLoc value for this SeqLocEquivType.
     * 
     * @param seqLoc
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqLocEquivType)) return false;
        SeqLocEquivType other = (SeqLocEquivType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqLocEquivType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-loc-equivType"));
