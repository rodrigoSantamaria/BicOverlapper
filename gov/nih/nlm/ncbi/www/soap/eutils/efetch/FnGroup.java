...
public class FnGroup  implements java.io.Serializable {
    ...
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch.Fn getFn(int i) {
        return this.fn[i];
    }

    public void setFn(int i, gov.nih.nlm.ncbi.www.soap.eutils.efetch.Fn _value) {
        this.fn[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">fn-group"));
