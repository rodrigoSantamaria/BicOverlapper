/**
 * BiostrucSource_databaseEntryIdType.java
 *
...
public class BiostrucSource_databaseEntryIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiostrucIdType biostrucId;

    public BiostrucSource_databaseEntryIdType() {
    }
    ...
    /**
     * Gets the biostrucId value for this BiostrucSource_databaseEntryIdType.
     * 
     * @return biostrucId
     */
    ...
    /**
     * Sets the biostrucId value for this BiostrucSource_databaseEntryIdType.
     * 
     * @param biostrucId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucSource_databaseEntryIdType)) return false;
        BiostrucSource_databaseEntryIdType other = (BiostrucSource_databaseEntryIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucSource_databaseEntryIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-source_database-entry-idType"));
