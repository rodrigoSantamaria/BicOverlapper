/**
 * ID2SSeqLoc_wholeSeqIdType.java
 *
...
public class ID2SSeqLoc_wholeSeqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID2SSeqLoc_wholeSeqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2SSeqLoc_wholeSeqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2SSeqLoc_wholeSeqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqLoc_wholeSeqIdType)) return false;
        ID2SSeqLoc_wholeSeqIdType other = (ID2SSeqLoc_wholeSeqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqLoc_wholeSeqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-loc_whole-seq-idType"));
