/**
 * ID2SReplyGetChunk_dataType.java
 *
...
public class ID2SReplyGetChunk_dataType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2ReplyDataType ID2ReplyData;

    public ID2SReplyGetChunk_dataType() {
    }
    ...
    /**
     * Gets the ID2ReplyData value for this ID2SReplyGetChunk_dataType.
     * 
     * @return ID2ReplyData
     */
    ...
    /**
     * Sets the ID2ReplyData value for this ID2SReplyGetChunk_dataType.
     * 
     * @param ID2ReplyData
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SReplyGetChunk_dataType)) return false;
        ID2SReplyGetChunk_dataType other = (ID2SReplyGetChunk_dataType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SReplyGetChunk_dataType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Reply-Get-Chunk_dataType"));
