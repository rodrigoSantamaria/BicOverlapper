/**
 * ID1ServerRequest_getsewithinfoType.java
 *
...
public class ID1ServerRequest_getsewithinfoType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID1ServerMaxcomplexType ID1ServerMaxcomplex;

    public ID1ServerRequest_getsewithinfoType() {
    }
    ...
    /**
     * Gets the ID1ServerMaxcomplex value for this ID1ServerRequest_getsewithinfoType.
     * 
    ...
    /**
     * Sets the ID1ServerMaxcomplex value for this ID1ServerRequest_getsewithinfoType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1ServerRequest_getsewithinfoType)) return false;
        ID1ServerRequest_getsewithinfoType other = (ID1ServerRequest_getsewithinfoType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1ServerRequest_getsewithinfoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1server-request_getsewithinfoType"));
