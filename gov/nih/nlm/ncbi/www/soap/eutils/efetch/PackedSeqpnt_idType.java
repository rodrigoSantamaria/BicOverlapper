...
public class PackedSeqpnt_idType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public PackedSeqpnt_idType() {
    }
    ...
    /**
     * Gets the seqId value for this PackedSeqpnt_idType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this PackedSeqpnt_idType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PackedSeqpnt_idType)) return false;
        PackedSeqpnt_idType other = (PackedSeqpnt_idType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PackedSeqpnt_idType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Packed-seqpnt_idType"));
