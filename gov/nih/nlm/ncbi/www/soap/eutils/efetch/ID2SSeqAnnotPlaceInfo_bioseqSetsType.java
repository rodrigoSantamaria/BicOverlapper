/**
 * ID2SSeqAnnotPlaceInfo_bioseqSetsType.java
 *
...
public class ID2SSeqAnnotPlaceInfo_bioseqSetsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SBioseqSetIdsType ID2SBioseqSetIds;

    public ID2SSeqAnnotPlaceInfo_bioseqSetsType() {
    }
    ...
    /**
     * Gets the ID2SBioseqSetIds value for this ID2SSeqAnnotPlaceInfo_bioseqSetsType.
     * 
    ...
    /**
     * Sets the ID2SBioseqSetIds value for this ID2SSeqAnnotPlaceInfo_bioseqSetsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqAnnotPlaceInfo_bioseqSetsType)) return false;
        ID2SSeqAnnotPlaceInfo_bioseqSetsType other = (ID2SSeqAnnotPlaceInfo_bioseqSetsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqAnnotPlaceInfo_bioseqSetsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-annot-place-Info_bioseq-setsType"));
