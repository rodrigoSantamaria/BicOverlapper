...
public class Cdd_childrenType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.CddIdSetType cddIdSet;

    public Cdd_childrenType() {
    }
    ...
    /**
     * Gets the cddIdSet value for this Cdd_childrenType.
     * 
     * @return cddIdSet
     */
    ...
    /**
     * Sets the cddIdSet value for this Cdd_childrenType.
     * 
     * @param cddIdSet
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Cdd_childrenType)) return false;
        Cdd_childrenType other = (Cdd_childrenType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Cdd_childrenType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Cdd_childrenType"));
