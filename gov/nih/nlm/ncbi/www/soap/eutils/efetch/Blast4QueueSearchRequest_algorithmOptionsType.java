/**
 * Blast4QueueSearchRequest_algorithmOptionsType.java
 *
...
public class Blast4QueueSearchRequest_algorithmOptionsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4ParametersType blast4Parameters;

    public Blast4QueueSearchRequest_algorithmOptionsType() {
    }
    ...
    /**
     * Gets the blast4Parameters value for this Blast4QueueSearchRequest_algorithmOptionsType.
     * 
    ...
    /**
     * Sets the blast4Parameters value for this Blast4QueueSearchRequest_algorithmOptionsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4QueueSearchRequest_algorithmOptionsType)) return false;
        Blast4QueueSearchRequest_algorithmOptionsType other = (Blast4QueueSearchRequest_algorithmOptionsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4QueueSearchRequest_algorithmOptionsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-queue-search-request_algorithm-optionsType"));
