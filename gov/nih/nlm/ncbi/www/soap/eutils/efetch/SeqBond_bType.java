...
public class SeqBond_bType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqPointType seqPoint;

    public SeqBond_bType() {
    }
    ...
    /**
     * Gets the seqPoint value for this SeqBond_bType.
     * 
     * @return seqPoint
     */
    ...
    /**
     * Sets the seqPoint value for this SeqBond_bType.
     * 
     * @param seqPoint
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqBond_bType)) return false;
        SeqBond_bType other = (SeqBond_bType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqBond_bType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-bond_bType"));
