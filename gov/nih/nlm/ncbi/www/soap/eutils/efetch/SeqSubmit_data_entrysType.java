/**
 * SeqSubmit_data_entrysType.java
 *
...
public class SeqSubmit_data_entrysType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqEntryType[] seqEntry;

    public SeqSubmit_data_entrysType() {
    }
    ...
    /**
     * Gets the seqEntry value for this SeqSubmit_data_entrysType.
     * 
     * @return seqEntry
     */
    ...
    /**
     * Sets the seqEntry value for this SeqSubmit_data_entrysType.
     * 
     * @param seqEntry
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqSubmit_data_entrysType)) return false;
        SeqSubmit_data_entrysType other = (SeqSubmit_data_entrysType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqSubmit_data_entrysType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-submit_data_entrysType"));
