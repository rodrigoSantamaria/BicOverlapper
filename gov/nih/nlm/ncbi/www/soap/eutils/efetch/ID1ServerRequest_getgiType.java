/**
 * ID1ServerRequest_getgiType.java
 *
...
public class ID1ServerRequest_getgiType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID1ServerRequest_getgiType() {
    }
    ...
    /**
     * Gets the seqId value for this ID1ServerRequest_getgiType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID1ServerRequest_getgiType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1ServerRequest_getgiType)) return false;
        ID1ServerRequest_getgiType other = (ID1ServerRequest_getgiType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1ServerRequest_getgiType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1server-request_getgiType"));
