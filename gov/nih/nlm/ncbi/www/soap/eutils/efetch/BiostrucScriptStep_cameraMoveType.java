/**
 * BiostrucScriptStep_cameraMoveType.java
 *
...
public class BiostrucScriptStep_cameraMoveType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.TransformType transform;

    public BiostrucScriptStep_cameraMoveType() {
    }
    ...
    /**
     * Gets the transform value for this BiostrucScriptStep_cameraMoveType.
     * 
     * @return transform
     */
    ...
    /**
     * Sets the transform value for this BiostrucScriptStep_cameraMoveType.
     * 
     * @param transform
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucScriptStep_cameraMoveType)) return false;
        BiostrucScriptStep_cameraMoveType other = (BiostrucScriptStep_cameraMoveType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucScriptStep_cameraMoveType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-script-step_camera-moveType"));
