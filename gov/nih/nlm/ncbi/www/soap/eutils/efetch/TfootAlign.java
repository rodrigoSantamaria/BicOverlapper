...
public class TfootAlign implements java.io.Serializable {
    ...
    // Constructor
    protected TfootAlign(org.apache.axis.types.Token value) {
        _value_ = value;
    ...
    public static TfootAlign fromValue(org.apache.axis.types.Token value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>tfoot>align"));
    }
    /**
