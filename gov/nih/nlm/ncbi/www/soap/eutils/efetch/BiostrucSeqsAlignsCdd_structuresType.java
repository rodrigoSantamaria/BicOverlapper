/**
 * BiostrucSeqsAlignsCdd_structuresType.java
 *
...
public class BiostrucSeqsAlignsCdd_structuresType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiostrucType[] biostruc;

    public BiostrucSeqsAlignsCdd_structuresType() {
    }
    ...
    /**
     * Gets the biostruc value for this BiostrucSeqsAlignsCdd_structuresType.
     * 
     * @return biostruc
     */
    ...
    /**
     * Sets the biostruc value for this BiostrucSeqsAlignsCdd_structuresType.
     * 
     * @param biostruc
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucSeqsAlignsCdd_structuresType)) return false;
        BiostrucSeqsAlignsCdd_structuresType other = (BiostrucSeqsAlignsCdd_structuresType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucSeqsAlignsCdd_structuresType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-seqs-aligns-cdd_structuresType"));
