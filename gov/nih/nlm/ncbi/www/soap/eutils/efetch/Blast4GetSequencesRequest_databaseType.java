/**
 * Blast4GetSequencesRequest_databaseType.java
 *
...
public class Blast4GetSequencesRequest_databaseType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4DatabaseType blast4Database;

    public Blast4GetSequencesRequest_databaseType() {
    }
    ...
    /**
     * Gets the blast4Database value for this Blast4GetSequencesRequest_databaseType.
     * 
    ...
    /**
     * Sets the blast4Database value for this Blast4GetSequencesRequest_databaseType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4GetSequencesRequest_databaseType)) return false;
        Blast4GetSequencesRequest_databaseType other = (Blast4GetSequencesRequest_databaseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4GetSequencesRequest_databaseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-get-sequences-request_databaseType"));
