...
public class ID2Request_paramsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2ParamsType ID2Params;

    public ID2Request_paramsType() {
    }
    ...
    /**
     * Gets the ID2Params value for this ID2Request_paramsType.
     * 
     * @return ID2Params
     */
    ...
    /**
     * Sets the ID2Params value for this ID2Request_paramsType.
     * 
     * @param ID2Params
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2Request_paramsType)) return false;
        ID2Request_paramsType other = (ID2Request_paramsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2Request_paramsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Request_paramsType"));
