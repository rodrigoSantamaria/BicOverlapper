/**
 * ID1ServerRequest_getblobinfoType.java
 *
...
public class ID1ServerRequest_getblobinfoType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID1ServerMaxcomplexType ID1ServerMaxcomplex;

    public ID1ServerRequest_getblobinfoType() {
    }
    ...
    /**
     * Gets the ID1ServerMaxcomplex value for this ID1ServerRequest_getblobinfoType.
     * 
    ...
    /**
     * Sets the ID1ServerMaxcomplex value for this ID1ServerRequest_getblobinfoType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1ServerRequest_getblobinfoType)) return false;
        ID1ServerRequest_getblobinfoType other = (ID1ServerRequest_getblobinfoType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1ServerRequest_getblobinfoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1server-request_getblobinfoType"));
