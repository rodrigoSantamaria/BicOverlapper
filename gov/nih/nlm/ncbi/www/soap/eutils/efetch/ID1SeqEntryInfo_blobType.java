...
public class ID1SeqEntryInfo_blobType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqEntryType seqEntry;

    public ID1SeqEntryInfo_blobType() {
    }
    ...
    /**
     * Gets the seqEntry value for this ID1SeqEntryInfo_blobType.
     * 
     * @return seqEntry
     */
    ...
    /**
     * Sets the seqEntry value for this ID1SeqEntryInfo_blobType.
     * 
     * @param seqEntry
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1SeqEntryInfo_blobType)) return false;
        ID1SeqEntryInfo_blobType other = (ID1SeqEntryInfo_blobType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1SeqEntryInfo_blobType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1SeqEntry-info_blobType"));
