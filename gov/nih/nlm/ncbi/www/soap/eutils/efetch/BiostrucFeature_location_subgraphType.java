/**
 * BiostrucFeature_location_subgraphType.java
 *
...
public class BiostrucFeature_location_subgraphType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ChemGraphPntrsType chemGraphPntrs;

    public BiostrucFeature_location_subgraphType() {
    }
    ...
    /**
     * Gets the chemGraphPntrs value for this BiostrucFeature_location_subgraphType.
     * 
    ...
    /**
     * Sets the chemGraphPntrs value for this BiostrucFeature_location_subgraphType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucFeature_location_subgraphType)) return false;
        BiostrucFeature_location_subgraphType other = (BiostrucFeature_location_subgraphType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucFeature_location_subgraphType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-feature_location_subgraphType"));
