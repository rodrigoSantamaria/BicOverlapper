/**
 * Entrezgene_nonUniqueKeysType.java
 *
...
public class Entrezgene_nonUniqueKeysType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.DbtagType[] dbtag;

    public Entrezgene_nonUniqueKeysType() {
    }
    ...
    /**
     * Gets the dbtag value for this Entrezgene_nonUniqueKeysType.
     * 
     * @return dbtag
     */
    ...
    /**
     * Sets the dbtag value for this Entrezgene_nonUniqueKeysType.
     * 
     * @param dbtag
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Entrezgene_nonUniqueKeysType)) return false;
        Entrezgene_nonUniqueKeysType other = (Entrezgene_nonUniqueKeysType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Entrezgene_nonUniqueKeysType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Entrezgene_non-unique-keysType"));
