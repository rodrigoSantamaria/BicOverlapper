...
public class Cdd_seqannotType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqAnnotType[] seqAnnot;

    public Cdd_seqannotType() {
    }
    ...
    /**
     * Gets the seqAnnot value for this Cdd_seqannotType.
     * 
     * @return seqAnnot
     */
    ...
    /**
     * Sets the seqAnnot value for this Cdd_seqannotType.
     * 
     * @param seqAnnot
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Cdd_seqannotType)) return false;
        Cdd_seqannotType other = (Cdd_seqannotType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Cdd_seqannotType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Cdd_seqannotType"));
