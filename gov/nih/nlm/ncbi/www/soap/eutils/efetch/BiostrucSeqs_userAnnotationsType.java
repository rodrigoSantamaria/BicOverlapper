/**
 * BiostrucSeqs_userAnnotationsType.java
 *
...
public class BiostrucSeqs_userAnnotationsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DUserAnnotationsType cn3DUserAnnotations;

    public BiostrucSeqs_userAnnotationsType() {
    }
    ...
    /**
     * Gets the cn3DUserAnnotations value for this BiostrucSeqs_userAnnotationsType.
     * 
    ...
    /**
     * Sets the cn3DUserAnnotations value for this BiostrucSeqs_userAnnotationsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucSeqs_userAnnotationsType)) return false;
        BiostrucSeqs_userAnnotationsType other = (BiostrucSeqs_userAnnotationsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucSeqs_userAnnotationsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-seqs_user-annotationsType"));
