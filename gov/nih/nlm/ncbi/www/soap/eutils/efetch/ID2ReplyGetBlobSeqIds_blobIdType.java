/**
 * ID2ReplyGetBlobSeqIds_blobIdType.java
 *
...
public class ID2ReplyGetBlobSeqIds_blobIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2BlobIdType ID2BlobId;

    public ID2ReplyGetBlobSeqIds_blobIdType() {
    }
    ...
    /**
     * Gets the ID2BlobId value for this ID2ReplyGetBlobSeqIds_blobIdType.
     * 
     * @return ID2BlobId
     */
    ...
    /**
     * Sets the ID2BlobId value for this ID2ReplyGetBlobSeqIds_blobIdType.
     * 
     * @param ID2BlobId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2ReplyGetBlobSeqIds_blobIdType)) return false;
        ID2ReplyGetBlobSeqIds_blobIdType other = (ID2ReplyGetBlobSeqIds_blobIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2ReplyGetBlobSeqIds_blobIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Reply-Get-Blob-Seq-ids_blob-idType"));
