/**
 * BiostrucAlignSeq_userAnnotationsType.java
 *
...
public class BiostrucAlignSeq_userAnnotationsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DUserAnnotationsType cn3DUserAnnotations;

    public BiostrucAlignSeq_userAnnotationsType() {
    }
    ...
    /**
     * Gets the cn3DUserAnnotations value for this BiostrucAlignSeq_userAnnotationsType.
     * 
    ...
    /**
     * Sets the cn3DUserAnnotations value for this BiostrucAlignSeq_userAnnotationsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucAlignSeq_userAnnotationsType)) return false;
        BiostrucAlignSeq_userAnnotationsType other = (BiostrucAlignSeq_userAnnotationsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucAlignSeq_userAnnotationsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-align-seq_user-annotationsType"));
