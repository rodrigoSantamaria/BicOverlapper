...
public class ID1ServerBack_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public ID1ServerBack_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this ID1ServerBack_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID1ServerBack_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1ServerBack_idsType)) return false;
        ID1ServerBack_idsType other = (ID1ServerBack_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1ServerBack_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1server-back_idsType"));
