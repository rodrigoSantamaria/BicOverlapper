...
public class FeatId_giimType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.GiimportIdType giimportId;

    public FeatId_giimType() {
    }
    ...
    /**
     * Gets the giimportId value for this FeatId_giimType.
     * 
     * @return giimportId
     */
    ...
    /**
     * Sets the giimportId value for this FeatId_giimType.
     * 
     * @param giimportId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FeatId_giimType)) return false;
        FeatId_giimType other = (FeatId_giimType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FeatId_giimType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Feat-id_giimType"));
