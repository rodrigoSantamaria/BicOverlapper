/**
 * Blast4FinishParamsRequest_paramsType.java
 *
...
public class Blast4FinishParamsRequest_paramsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4ParametersType blast4Parameters;

    public Blast4FinishParamsRequest_paramsType() {
    }
    ...
    /**
     * Gets the blast4Parameters value for this Blast4FinishParamsRequest_paramsType.
     * 
    ...
    /**
     * Sets the blast4Parameters value for this Blast4FinishParamsRequest_paramsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4FinishParamsRequest_paramsType)) return false;
        Blast4FinishParamsRequest_paramsType other = (Blast4FinishParamsRequest_paramsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4FinishParamsRequest_paramsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-finish-params-request_paramsType"));
