/**
 * ID2SChunkData_bioseqsType.java
 *
...
public class ID2SChunkData_bioseqsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BioseqType[] bioseq;

    public ID2SChunkData_bioseqsType() {
    }
    ...
    /**
     * Gets the bioseq value for this ID2SChunkData_bioseqsType.
     * 
     * @return bioseq
     */
    ...
    /**
     * Sets the bioseq value for this ID2SChunkData_bioseqsType.
     * 
     * @param bioseq
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SChunkData_bioseqsType)) return false;
        ID2SChunkData_bioseqsType other = (ID2SChunkData_bioseqsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SChunkData_bioseqsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Chunk-Data_bioseqsType"));
