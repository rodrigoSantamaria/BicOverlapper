...
public class ColValign implements java.io.Serializable {
    ...
    // Constructor
    protected ColValign(org.apache.axis.types.Token value) {
        _value_ = value;
    ...
    public static ColValign fromValue(org.apache.axis.types.Token value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>col>valign"));
    }
    /**
