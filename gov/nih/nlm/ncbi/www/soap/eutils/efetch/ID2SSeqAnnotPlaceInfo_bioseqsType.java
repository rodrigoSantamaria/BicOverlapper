/**
 * ID2SSeqAnnotPlaceInfo_bioseqsType.java
 *
...
public class ID2SSeqAnnotPlaceInfo_bioseqsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SBioseqIdsType ID2SBioseqIds;

    public ID2SSeqAnnotPlaceInfo_bioseqsType() {
    }
    ...
    /**
     * Gets the ID2SBioseqIds value for this ID2SSeqAnnotPlaceInfo_bioseqsType.
     * 
    ...
    /**
     * Sets the ID2SBioseqIds value for this ID2SSeqAnnotPlaceInfo_bioseqsType.
     * 
     * @param ID2SBioseqIds
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqAnnotPlaceInfo_bioseqsType)) return false;
        ID2SSeqAnnotPlaceInfo_bioseqsType other = (ID2SSeqAnnotPlaceInfo_bioseqsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqAnnotPlaceInfo_bioseqsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-annot-place-Info_bioseqsType"));
