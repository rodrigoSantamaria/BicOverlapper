...
public class DenseDiag_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public DenseDiag_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this DenseDiag_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this DenseDiag_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DenseDiag_idsType)) return false;
        DenseDiag_idsType other = (DenseDiag_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DenseDiag_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Dense-diag_idsType"));
