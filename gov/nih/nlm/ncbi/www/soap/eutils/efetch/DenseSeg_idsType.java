...
public class DenseSeg_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public DenseSeg_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this DenseSeg_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this DenseSeg_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DenseSeg_idsType)) return false;
        DenseSeg_idsType other = (DenseSeg_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DenseSeg_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Dense-seg_idsType"));
