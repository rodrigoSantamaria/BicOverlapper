/**
 * BundleSeqsAligns_styleDictionaryType.java
 *
...
public class BundleSeqsAligns_styleDictionaryType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DStyleDictionaryType cn3DStyleDictionary;

    public BundleSeqsAligns_styleDictionaryType() {
    }
    ...
    /**
     * Gets the cn3DStyleDictionary value for this BundleSeqsAligns_styleDictionaryType.
     * 
    ...
    /**
     * Sets the cn3DStyleDictionary value for this BundleSeqsAligns_styleDictionaryType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BundleSeqsAligns_styleDictionaryType)) return false;
        BundleSeqsAligns_styleDictionaryType other = (BundleSeqsAligns_styleDictionaryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BundleSeqsAligns_styleDictionaryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Bundle-seqs-aligns_style-dictionaryType"));
