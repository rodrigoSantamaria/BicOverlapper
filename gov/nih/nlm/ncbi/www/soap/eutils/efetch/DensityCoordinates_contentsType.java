/**
 * DensityCoordinates_contentsType.java
 *
...
public class DensityCoordinates_contentsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ChemGraphPntrsType chemGraphPntrs;

    public DensityCoordinates_contentsType() {
    }
    ...
    /**
     * Gets the chemGraphPntrs value for this DensityCoordinates_contentsType.
     * 
    ...
    /**
     * Sets the chemGraphPntrs value for this DensityCoordinates_contentsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DensityCoordinates_contentsType)) return false;
        DensityCoordinates_contentsType other = (DensityCoordinates_contentsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DensityCoordinates_contentsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Density-coordinates_contentsType"));
