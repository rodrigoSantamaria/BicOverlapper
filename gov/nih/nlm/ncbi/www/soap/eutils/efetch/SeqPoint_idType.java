...
public class SeqPoint_idType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public SeqPoint_idType() {
    }
    ...
    /**
     * Gets the seqId value for this SeqPoint_idType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this SeqPoint_idType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqPoint_idType)) return false;
        SeqPoint_idType other = (SeqPoint_idType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqPoint_idType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-point_idType"));
