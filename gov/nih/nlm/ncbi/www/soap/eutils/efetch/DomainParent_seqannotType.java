/**
 * DomainParent_seqannotType.java
 *
...
public class DomainParent_seqannotType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqAnnotType seqAnnot;

    public DomainParent_seqannotType() {
    }
    ...
    /**
     * Gets the seqAnnot value for this DomainParent_seqannotType.
     * 
     * @return seqAnnot
     */
    ...
    /**
     * Sets the seqAnnot value for this DomainParent_seqannotType.
     * 
     * @param seqAnnot
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DomainParent_seqannotType)) return false;
        DomainParent_seqannotType other = (DomainParent_seqannotType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DomainParent_seqannotType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Domain-parent_seqannotType"));
