/**
 * BiostrucAlign_styleDictionaryType.java
 *
...
public class BiostrucAlign_styleDictionaryType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DStyleDictionaryType cn3DStyleDictionary;

    public BiostrucAlign_styleDictionaryType() {
    }
    ...
    /**
     * Gets the cn3DStyleDictionary value for this BiostrucAlign_styleDictionaryType.
     * 
    ...
    /**
     * Sets the cn3DStyleDictionary value for this BiostrucAlign_styleDictionaryType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucAlign_styleDictionaryType)) return false;
        BiostrucAlign_styleDictionaryType other = (BiostrucAlign_styleDictionaryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucAlign_styleDictionaryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-align_style-dictionaryType"));
