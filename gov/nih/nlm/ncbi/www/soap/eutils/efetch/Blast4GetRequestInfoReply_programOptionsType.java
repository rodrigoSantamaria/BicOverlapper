/**
 * Blast4GetRequestInfoReply_programOptionsType.java
 *
...
public class Blast4GetRequestInfoReply_programOptionsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4ParametersType blast4Parameters;

    public Blast4GetRequestInfoReply_programOptionsType() {
    }
    ...
    /**
     * Gets the blast4Parameters value for this Blast4GetRequestInfoReply_programOptionsType.
     * 
    ...
    /**
     * Sets the blast4Parameters value for this Blast4GetRequestInfoReply_programOptionsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4GetRequestInfoReply_programOptionsType)) return false;
        Blast4GetRequestInfoReply_programOptionsType other = (Blast4GetRequestInfoReply_programOptionsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4GetRequestInfoReply_programOptionsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-get-request-info-reply_program-optionsType"));
