...
public class ID2SGiInts_intsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SIntervalType[] ID2SInterval;

    public ID2SGiInts_intsType() {
    }
    ...
    /**
     * Gets the ID2SInterval value for this ID2SGiInts_intsType.
     * 
     * @return ID2SInterval
     */
    ...
    /**
     * Sets the ID2SInterval value for this ID2SGiInts_intsType.
     * 
     * @param ID2SInterval
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SGiInts_intsType)) return false;
        ID2SGiInts_intsType other = (ID2SGiInts_intsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SGiInts_intsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Gi-Ints_intsType"));
