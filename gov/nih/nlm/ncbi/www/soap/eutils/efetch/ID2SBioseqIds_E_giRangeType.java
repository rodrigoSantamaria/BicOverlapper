/**
 * ID2SBioseqIds_E_giRangeType.java
 *
...
public class ID2SBioseqIds_E_giRangeType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SGiRangeType ID2SGiRange;

    public ID2SBioseqIds_E_giRangeType() {
    }
    ...
    /**
     * Gets the ID2SGiRange value for this ID2SBioseqIds_E_giRangeType.
     * 
     * @return ID2SGiRange
     */
    ...
    /**
     * Sets the ID2SGiRange value for this ID2SBioseqIds_E_giRangeType.
     * 
     * @param ID2SGiRange
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SBioseqIds_E_giRangeType)) return false;
        ID2SBioseqIds_E_giRangeType other = (ID2SBioseqIds_E_giRangeType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SBioseqIds_E_giRangeType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Bioseq-Ids_E_gi-rangeType"));
