/**
 * ID1ServerBack_gotdeadseqentryType.java
 *
...
public class ID1ServerBack_gotdeadseqentryType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqEntryType seqEntry;

    public ID1ServerBack_gotdeadseqentryType() {
    }
    ...
    /**
     * Gets the seqEntry value for this ID1ServerBack_gotdeadseqentryType.
     * 
     * @return seqEntry
     */
    ...
    /**
     * Sets the seqEntry value for this ID1ServerBack_gotdeadseqentryType.
     * 
     * @param seqEntry
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1ServerBack_gotdeadseqentryType)) return false;
        ID1ServerBack_gotdeadseqentryType other = (ID1ServerBack_gotdeadseqentryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1ServerBack_gotdeadseqentryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1server-back_gotdeadseqentryType"));
