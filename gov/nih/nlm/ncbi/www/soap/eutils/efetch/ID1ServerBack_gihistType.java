...
public class ID1ServerBack_gihistType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID1SeqHistType[] ID1SeqHist;

    public ID1ServerBack_gihistType() {
    }
    ...
    /**
     * Gets the ID1SeqHist value for this ID1ServerBack_gihistType.
     * 
     * @return ID1SeqHist
     */
    ...
    /**
     * Sets the ID1SeqHist value for this ID1ServerBack_gihistType.
     * 
     * @param ID1SeqHist
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID1ServerBack_gihistType)) return false;
        ID1ServerBack_gihistType other = (ID1ServerBack_gihistType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID1ServerBack_gihistType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID1server-back_gihistType"));
