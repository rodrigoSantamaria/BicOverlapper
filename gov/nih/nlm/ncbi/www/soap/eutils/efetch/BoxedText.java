...
public class BoxedText  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BoxedTextPosition position;  // attribute
    ...
    public BoxedText(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch.BoxedTextPosition position,
     ...
     * @return position
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch.BoxedTextPosition getPosition() {
        return position;
    }
     ...
     * @param position
     */
    public void setPosition(gov.nih.nlm.ncbi.www.soap.eutils.efetch.BoxedTextPosition position) {
        this.position = position;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">boxed-text"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>boxed-text>position"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
