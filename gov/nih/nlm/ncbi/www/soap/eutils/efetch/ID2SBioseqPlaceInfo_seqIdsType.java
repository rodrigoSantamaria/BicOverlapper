/**
 * ID2SBioseqPlaceInfo_seqIdsType.java
 *
...
public class ID2SBioseqPlaceInfo_seqIdsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SBioseqIdsType ID2SBioseqIds;

    public ID2SBioseqPlaceInfo_seqIdsType() {
    }
    ...
    /**
     * Gets the ID2SBioseqIds value for this ID2SBioseqPlaceInfo_seqIdsType.
     * 
    ...
    /**
     * Sets the ID2SBioseqIds value for this ID2SBioseqPlaceInfo_seqIdsType.
     * 
     * @param ID2SBioseqIds
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SBioseqPlaceInfo_seqIdsType)) return false;
        ID2SBioseqPlaceInfo_seqIdsType other = (ID2SBioseqPlaceInfo_seqIdsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SBioseqPlaceInfo_seqIdsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Bioseq-place-Info_seq-idsType"));
