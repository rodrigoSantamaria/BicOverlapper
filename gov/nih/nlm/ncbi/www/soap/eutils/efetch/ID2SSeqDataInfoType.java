...
public class ID2SSeqDataInfoType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SSeqLocType ID2SSeqLoc;

    public ID2SSeqDataInfoType() {
    }
    ...
    /**
     * Gets the ID2SSeqLoc value for this ID2SSeqDataInfoType.
     * 
     * @return ID2SSeqLoc
     */
    ...
    /**
     * Sets the ID2SSeqLoc value for this ID2SSeqDataInfoType.
     * 
     * @param ID2SSeqLoc
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqDataInfoType)) return false;
        ID2SSeqDataInfoType other = (ID2SSeqDataInfoType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqDataInfoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-data-InfoType"));
