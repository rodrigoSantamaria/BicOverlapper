...
public class PIRBlock_seqrefType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public PIRBlock_seqrefType() {
    }
    ...
    /**
     * Gets the seqId value for this PIRBlock_seqrefType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this PIRBlock_seqrefType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PIRBlock_seqrefType)) return false;
        PIRBlock_seqrefType other = (PIRBlock_seqrefType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PIRBlock_seqrefType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "PIR-block_seqrefType"));
