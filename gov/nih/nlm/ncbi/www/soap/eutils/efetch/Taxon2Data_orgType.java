...
public class Taxon2Data_orgType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.OrgRefType orgRef;

    public Taxon2Data_orgType() {
    }
    ...
    /**
     * Gets the orgRef value for this Taxon2Data_orgType.
     * 
     * @return orgRef
     */
    ...
    /**
     * Sets the orgRef value for this Taxon2Data_orgType.
     * 
     * @param orgRef
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Taxon2Data_orgType)) return false;
        Taxon2Data_orgType other = (Taxon2Data_orgType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Taxon2Data_orgType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Taxon2-data_orgType"));
