/**
 * ID2ReplyGetSeqId_seqIdType.java
 *
...
public class ID2ReplyGetSeqId_seqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public ID2ReplyGetSeqId_seqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2ReplyGetSeqId_seqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2ReplyGetSeqId_seqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2ReplyGetSeqId_seqIdType)) return false;
        ID2ReplyGetSeqId_seqIdType other = (ID2ReplyGetSeqId_seqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2ReplyGetSeqId_seqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Reply-Get-Seq-id_seq-idType"));
