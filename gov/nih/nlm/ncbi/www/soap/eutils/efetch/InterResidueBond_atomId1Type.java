/**
 * InterResidueBond_atomId1Type.java
 *
...
public class InterResidueBond_atomId1Type  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.AtomPntrType atomPntr;

    public InterResidueBond_atomId1Type() {
    }
    ...
    /**
     * Gets the atomPntr value for this InterResidueBond_atomId1Type.
     * 
     * @return atomPntr
     */
    ...
    /**
     * Sets the atomPntr value for this InterResidueBond_atomId1Type.
     * 
     * @param atomPntr
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InterResidueBond_atomId1Type)) return false;
        InterResidueBond_atomId1Type other = (InterResidueBond_atomId1Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InterResidueBond_atomId1Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Inter-residue-bond_atom-id-1Type"));
