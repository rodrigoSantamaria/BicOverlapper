/**
 * ID2Request_request_getBlobIdType.java
 *
...
public class ID2Request_request_getBlobIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2RequestGetBlobIdType ID2RequestGetBlobId;

    public ID2Request_request_getBlobIdType() {
    }
    ...
    /**
     * Gets the ID2RequestGetBlobId value for this ID2Request_request_getBlobIdType.
     * 
    ...
    /**
     * Sets the ID2RequestGetBlobId value for this ID2Request_request_getBlobIdType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2Request_request_getBlobIdType)) return false;
        ID2Request_request_getBlobIdType other = (ID2Request_request_getBlobIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2Request_request_getBlobIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Request_request_get-blob-idType"));
