/**
 * ID2ReplyGetBlobId_seqIdType.java
 *
...
public class ID2ReplyGetBlobId_seqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID2ReplyGetBlobId_seqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2ReplyGetBlobId_seqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2ReplyGetBlobId_seqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2ReplyGetBlobId_seqIdType)) return false;
        ID2ReplyGetBlobId_seqIdType other = (ID2ReplyGetBlobId_seqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2ReplyGetBlobId_seqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Reply-Get-Blob-Id_seq-idType"));
