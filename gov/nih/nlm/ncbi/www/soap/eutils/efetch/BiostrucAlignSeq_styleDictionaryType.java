/**
 * BiostrucAlignSeq_styleDictionaryType.java
 *
...
public class BiostrucAlignSeq_styleDictionaryType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DStyleDictionaryType cn3DStyleDictionary;

    public BiostrucAlignSeq_styleDictionaryType() {
    }
    ...
    /**
     * Gets the cn3DStyleDictionary value for this BiostrucAlignSeq_styleDictionaryType.
     * 
    ...
    /**
     * Sets the cn3DStyleDictionary value for this BiostrucAlignSeq_styleDictionaryType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucAlignSeq_styleDictionaryType)) return false;
        BiostrucAlignSeq_styleDictionaryType other = (BiostrucAlignSeq_styleDictionaryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucAlignSeq_styleDictionaryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-align-seq_style-dictionaryType"));
