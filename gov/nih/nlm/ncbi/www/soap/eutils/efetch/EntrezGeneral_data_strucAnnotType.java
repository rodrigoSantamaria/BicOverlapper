/**
 * EntrezGeneral_data_strucAnnotType.java
 *
...
public class EntrezGeneral_data_strucAnnotType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiostrucAnnotSetType biostrucAnnotSet;

    public EntrezGeneral_data_strucAnnotType() {
    }
    ...
    /**
     * Gets the biostrucAnnotSet value for this EntrezGeneral_data_strucAnnotType.
     * 
    ...
    /**
     * Sets the biostrucAnnotSet value for this EntrezGeneral_data_strucAnnotType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EntrezGeneral_data_strucAnnotType)) return false;
        EntrezGeneral_data_strucAnnotType other = (EntrezGeneral_data_strucAnnotType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EntrezGeneral_data_strucAnnotType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Entrez-general_data_strucAnnotType"));
