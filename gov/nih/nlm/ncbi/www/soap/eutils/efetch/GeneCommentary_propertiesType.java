/**
 * GeneCommentary_propertiesType.java
 *
...
public class GeneCommentary_propertiesType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.GeneCommentaryType[] geneCommentary;

    public GeneCommentary_propertiesType() {
    }
    ...
    /**
     * Gets the geneCommentary value for this GeneCommentary_propertiesType.
     * 
    ...
    /**
     * Sets the geneCommentary value for this GeneCommentary_propertiesType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GeneCommentary_propertiesType)) return false;
        GeneCommentary_propertiesType other = (GeneCommentary_propertiesType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GeneCommentary_propertiesType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Gene-commentary_propertiesType"));
