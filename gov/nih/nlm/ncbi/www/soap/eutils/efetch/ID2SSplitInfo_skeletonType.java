/**
 * ID2SSplitInfo_skeletonType.java
 *
...
public class ID2SSplitInfo_skeletonType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqEntryType seqEntry;

    public ID2SSplitInfo_skeletonType() {
    }
    ...
    /**
     * Gets the seqEntry value for this ID2SSplitInfo_skeletonType.
     * 
     * @return seqEntry
     */
    ...
    /**
     * Sets the seqEntry value for this ID2SSplitInfo_skeletonType.
     * 
     * @param seqEntry
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSplitInfo_skeletonType)) return false;
        ID2SSplitInfo_skeletonType other = (ID2SSplitInfo_skeletonType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSplitInfo_skeletonType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Split-Info_skeletonType"));
