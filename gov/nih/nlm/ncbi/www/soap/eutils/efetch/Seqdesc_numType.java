...
public class Seqdesc_numType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.NumberingType numbering;

    public Seqdesc_numType() {
    }
    ...
    /**
     * Gets the numbering value for this Seqdesc_numType.
     * 
     * @return numbering
     */
    ...
    /**
     * Sets the numbering value for this Seqdesc_numType.
     * 
     * @param numbering
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Seqdesc_numType)) return false;
        Seqdesc_numType other = (Seqdesc_numType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Seqdesc_numType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seqdesc_numType"));
