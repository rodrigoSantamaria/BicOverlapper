/**
 * BiostrucSeq_userAnnotationsType.java
 *
...
public class BiostrucSeq_userAnnotationsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DUserAnnotationsType cn3DUserAnnotations;

    public BiostrucSeq_userAnnotationsType() {
    }
    ...
    /**
     * Gets the cn3DUserAnnotations value for this BiostrucSeq_userAnnotationsType.
     * 
    ...
    /**
     * Sets the cn3DUserAnnotations value for this BiostrucSeq_userAnnotationsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucSeq_userAnnotationsType)) return false;
        BiostrucSeq_userAnnotationsType other = (BiostrucSeq_userAnnotationsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucSeq_userAnnotationsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-seq_user-annotationsType"));
