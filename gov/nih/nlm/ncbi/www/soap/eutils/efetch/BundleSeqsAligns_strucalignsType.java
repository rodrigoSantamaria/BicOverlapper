/**
 * BundleSeqsAligns_strucalignsType.java
 *
...
public class BundleSeqsAligns_strucalignsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiostrucAnnotSetType biostrucAnnotSet;

    public BundleSeqsAligns_strucalignsType() {
    }
    ...
    /**
     * Gets the biostrucAnnotSet value for this BundleSeqsAligns_strucalignsType.
     * 
    ...
    /**
     * Sets the biostrucAnnotSet value for this BundleSeqsAligns_strucalignsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BundleSeqsAligns_strucalignsType)) return false;
        BundleSeqsAligns_strucalignsType other = (BundleSeqsAligns_strucalignsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BundleSeqsAligns_strucalignsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Bundle-seqs-aligns_strucalignsType"));
