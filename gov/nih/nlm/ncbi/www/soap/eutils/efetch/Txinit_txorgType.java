...
public class Txinit_txorgType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.OrgRefType orgRef;

    public Txinit_txorgType() {
    }
    ...
    /**
     * Gets the orgRef value for this Txinit_txorgType.
     * 
     * @return orgRef
     */
    ...
    /**
     * Sets the orgRef value for this Txinit_txorgType.
     * 
     * @param orgRef
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Txinit_txorgType)) return false;
        Txinit_txorgType other = (Txinit_txorgType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Txinit_txorgType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Txinit_txorgType"));
