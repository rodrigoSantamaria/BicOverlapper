...
public class PackedSeqpnt_strandType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.NaStrandType naStrand;

    public PackedSeqpnt_strandType() {
    }
    ...
    /**
     * Gets the naStrand value for this PackedSeqpnt_strandType.
     * 
     * @return naStrand
     */
    ...
    /**
     * Sets the naStrand value for this PackedSeqpnt_strandType.
     * 
     * @param naStrand
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PackedSeqpnt_strandType)) return false;
        PackedSeqpnt_strandType other = (PackedSeqpnt_strandType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PackedSeqpnt_strandType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Packed-seqpnt_strandType"));
