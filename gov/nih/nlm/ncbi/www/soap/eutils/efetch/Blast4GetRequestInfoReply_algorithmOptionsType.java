/**
 * Blast4GetRequestInfoReply_algorithmOptionsType.java
 *
...
public class Blast4GetRequestInfoReply_algorithmOptionsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4ParametersType blast4Parameters;

    public Blast4GetRequestInfoReply_algorithmOptionsType() {
    }
    ...
    /**
     * Gets the blast4Parameters value for this Blast4GetRequestInfoReply_algorithmOptionsType.
     * 
    ...
    /**
     * Sets the blast4Parameters value for this Blast4GetRequestInfoReply_algorithmOptionsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4GetRequestInfoReply_algorithmOptionsType)) return false;
        Blast4GetRequestInfoReply_algorithmOptionsType other = (Blast4GetRequestInfoReply_algorithmOptionsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4GetRequestInfoReply_algorithmOptionsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-get-request-info-reply_algorithm-optionsType"));
