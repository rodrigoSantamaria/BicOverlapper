...
public class ThAlign implements java.io.Serializable {
    ...
    // Constructor
    protected ThAlign(org.apache.axis.types.Token value) {
        _value_ = value;
    ...
    public static ThAlign fromValue(org.apache.axis.types.Token value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>th>align"));
    }
    /**
