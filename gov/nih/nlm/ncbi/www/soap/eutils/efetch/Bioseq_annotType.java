...
public class Bioseq_annotType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqAnnotType[] seqAnnot;

    public Bioseq_annotType() {
    }
    ...
    /**
     * Gets the seqAnnot value for this Bioseq_annotType.
     * 
     * @return seqAnnot
     */
    ...
    /**
     * Sets the seqAnnot value for this Bioseq_annotType.
     * 
     * @param seqAnnot
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Bioseq_annotType)) return false;
        Bioseq_annotType other = (Bioseq_annotType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Bioseq_annotType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Bioseq_annotType"));
