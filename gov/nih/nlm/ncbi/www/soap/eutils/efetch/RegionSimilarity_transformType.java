/**
 * RegionSimilarity_transformType.java
 *
...
public class RegionSimilarity_transformType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.TransformType[] transform;

    public RegionSimilarity_transformType() {
    }
    ...
    /**
     * Gets the transform value for this RegionSimilarity_transformType.
     * 
     * @return transform
     */
    ...
    /**
     * Sets the transform value for this RegionSimilarity_transformType.
     * 
     * @param transform
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RegionSimilarity_transformType)) return false;
        RegionSimilarity_transformType other = (RegionSimilarity_transformType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegionSimilarity_transformType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Region-similarity_transformType"));
