/**
 * ID2SSeqAnnotInfo_seqLocType.java
 *
...
public class ID2SSeqAnnotInfo_seqLocType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2SSeqLocType ID2SSeqLoc;

    public ID2SSeqAnnotInfo_seqLocType() {
    }
    ...
    /**
     * Gets the ID2SSeqLoc value for this ID2SSeqAnnotInfo_seqLocType.
     * 
     * @return ID2SSeqLoc
     */
    ...
    /**
     * Sets the ID2SSeqLoc value for this ID2SSeqAnnotInfo_seqLocType.
     * 
     * @param ID2SSeqLoc
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqAnnotInfo_seqLocType)) return false;
        ID2SSeqAnnotInfo_seqLocType other = (ID2SSeqAnnotInfo_seqLocType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqAnnotInfo_seqLocType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-annot-Info_seq-locType"));
