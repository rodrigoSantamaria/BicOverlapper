/**
 * BiostrucAlign_userAnnotationsType.java
 *
...
public class BiostrucAlign_userAnnotationsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DUserAnnotationsType cn3DUserAnnotations;

    public BiostrucAlign_userAnnotationsType() {
    }
    ...
    /**
     * Gets the cn3DUserAnnotations value for this BiostrucAlign_userAnnotationsType.
     * 
    ...
    /**
     * Sets the cn3DUserAnnotations value for this BiostrucAlign_userAnnotationsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucAlign_userAnnotationsType)) return false;
        BiostrucAlign_userAnnotationsType other = (BiostrucAlign_userAnnotationsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucAlign_userAnnotationsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-align_user-annotationsType"));
