...
public class PCSource_mmdbType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.PCMMDBSourceType PCMMDBSource;

    public PCSource_mmdbType() {
    }
    ...
    /**
     * Gets the PCMMDBSource value for this PCSource_mmdbType.
     * 
     * @return PCMMDBSource
     */
    ...
    /**
     * Sets the PCMMDBSource value for this PCSource_mmdbType.
     * 
     * @param PCMMDBSource
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PCSource_mmdbType)) return false;
        PCSource_mmdbType other = (PCSource_mmdbType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PCSource_mmdbType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "PC-Source_mmdbType"));
