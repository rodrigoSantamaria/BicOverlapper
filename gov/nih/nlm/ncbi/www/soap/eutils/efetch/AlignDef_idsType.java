...
public class AlignDef_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public AlignDef_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this AlignDef_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this AlignDef_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlignDef_idsType)) return false;
        AlignDef_idsType other = (AlignDef_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlignDef_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Align-def_idsType"));
