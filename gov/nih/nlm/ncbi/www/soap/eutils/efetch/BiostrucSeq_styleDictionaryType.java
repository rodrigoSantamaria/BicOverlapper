/**
 * BiostrucSeq_styleDictionaryType.java
 *
...
public class BiostrucSeq_styleDictionaryType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Cn3DStyleDictionaryType cn3DStyleDictionary;

    public BiostrucSeq_styleDictionaryType() {
    }
    ...
    /**
     * Gets the cn3DStyleDictionary value for this BiostrucSeq_styleDictionaryType.
     * 
    ...
    /**
     * Sets the cn3DStyleDictionary value for this BiostrucSeq_styleDictionaryType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucSeq_styleDictionaryType)) return false;
        BiostrucSeq_styleDictionaryType other = (BiostrucSeq_styleDictionaryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucSeq_styleDictionaryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-seq_style-dictionaryType"));
