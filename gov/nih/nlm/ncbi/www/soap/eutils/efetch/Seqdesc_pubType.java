...
public class Seqdesc_pubType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.PubdescType pubdesc;

    public Seqdesc_pubType() {
    }
    ...
    /**
     * Gets the pubdesc value for this Seqdesc_pubType.
     * 
     * @return pubdesc
     */
    ...
    /**
     * Sets the pubdesc value for this Seqdesc_pubType.
     * 
     * @param pubdesc
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Seqdesc_pubType)) return false;
        Seqdesc_pubType other = (Seqdesc_pubType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Seqdesc_pubType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seqdesc_pubType"));
