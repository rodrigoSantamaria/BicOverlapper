...
public class TrAlign implements java.io.Serializable {
    ...
    // Constructor
    protected TrAlign(org.apache.axis.types.Token value) {
        _value_ = value;
    ...
    public static TrAlign fromValue(org.apache.axis.types.Token value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>tr>align"));
    }
    /**
