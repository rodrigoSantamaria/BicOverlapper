/**
 * ID2SBioseqIds_E_seqIdType.java
 *
...
public class ID2SBioseqIds_E_seqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID2SBioseqIds_E_seqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2SBioseqIds_E_seqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2SBioseqIds_E_seqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SBioseqIds_E_seqIdType)) return false;
        ID2SBioseqIds_E_seqIdType other = (ID2SBioseqIds_E_seqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SBioseqIds_E_seqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Bioseq-Ids_E_seq-idType"));
