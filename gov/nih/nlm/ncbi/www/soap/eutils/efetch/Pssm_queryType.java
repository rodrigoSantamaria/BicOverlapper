...
public class Pssm_queryType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqEntryType seqEntry;

    public Pssm_queryType() {
    }
    ...
    /**
     * Gets the seqEntry value for this Pssm_queryType.
     * 
     * @return seqEntry
     */
    ...
    /**
     * Sets the seqEntry value for this Pssm_queryType.
     * 
     * @param seqEntry
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Pssm_queryType)) return false;
        Pssm_queryType other = (Pssm_queryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Pssm_queryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Pssm_queryType"));
