/**
 * ID2ReplyGetBlobSeqIds_idsType.java
 *
...
public class ID2ReplyGetBlobSeqIds_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2ReplyDataType ID2ReplyData;

    public ID2ReplyGetBlobSeqIds_idsType() {
    }
    ...
    /**
     * Gets the ID2ReplyData value for this ID2ReplyGetBlobSeqIds_idsType.
     * 
     * @return ID2ReplyData
     */
    ...
    /**
     * Sets the ID2ReplyData value for this ID2ReplyGetBlobSeqIds_idsType.
     * 
     * @param ID2ReplyData
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2ReplyGetBlobSeqIds_idsType)) return false;
        ID2ReplyGetBlobSeqIds_idsType other = (ID2ReplyGetBlobSeqIds_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2ReplyGetBlobSeqIds_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Reply-Get-Blob-Seq-ids_idsType"));
