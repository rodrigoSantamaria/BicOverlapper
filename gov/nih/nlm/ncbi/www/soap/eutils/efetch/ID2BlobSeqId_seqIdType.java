...
public class ID2BlobSeqId_seqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID2BlobSeqId_seqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2BlobSeqId_seqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2BlobSeqId_seqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2BlobSeqId_seqIdType)) return false;
        ID2BlobSeqId_seqIdType other = (ID2BlobSeqId_seqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2BlobSeqId_seqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Blob-Seq-id_seq-idType"));
