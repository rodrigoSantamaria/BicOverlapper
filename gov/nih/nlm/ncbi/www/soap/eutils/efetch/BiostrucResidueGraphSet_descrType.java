/**
 * BiostrucResidueGraphSet_descrType.java
 *
...
public class BiostrucResidueGraphSet_descrType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.BiomolDescrType[] biomolDescr;

    public BiostrucResidueGraphSet_descrType() {
    }
    ...
    /**
     * Gets the biomolDescr value for this BiostrucResidueGraphSet_descrType.
     * 
     * @return biomolDescr
     */
    ...
    /**
     * Sets the biomolDescr value for this BiostrucResidueGraphSet_descrType.
     * 
     * @param biomolDescr
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucResidueGraphSet_descrType)) return false;
        BiostrucResidueGraphSet_descrType other = (BiostrucResidueGraphSet_descrType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucResidueGraphSet_descrType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-residue-graph-set_descrType"));
