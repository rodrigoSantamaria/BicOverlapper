...
public class Pubdesc_pubType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.PubEquivType pubEquiv;

    public Pubdesc_pubType() {
    }
    ...
    /**
     * Gets the pubEquiv value for this Pubdesc_pubType.
     * 
     * @return pubEquiv
     */
    ...
    /**
     * Sets the pubEquiv value for this Pubdesc_pubType.
     * 
     * @param pubEquiv
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Pubdesc_pubType)) return false;
        Pubdesc_pubType other = (Pubdesc_pubType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Pubdesc_pubType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Pubdesc_pubType"));
