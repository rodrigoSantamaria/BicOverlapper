...
public class StdSeg_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public StdSeg_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this StdSeg_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this StdSeg_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StdSeg_idsType)) return false;
        StdSeg_idsType other = (StdSeg_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StdSeg_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Std-seg_idsType"));
