/**
 * BiostrucGraph_interMoleculeBondsType.java
 *
...
public class BiostrucGraph_interMoleculeBondsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.InterResidueBondType[] interResidueBond;

    public BiostrucGraph_interMoleculeBondsType() {
    }
    ...
    /**
     * Gets the interResidueBond value for this BiostrucGraph_interMoleculeBondsType.
     * 
    ...
    /**
     * Sets the interResidueBond value for this BiostrucGraph_interMoleculeBondsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BiostrucGraph_interMoleculeBondsType)) return false;
        BiostrucGraph_interMoleculeBondsType other = (BiostrucGraph_interMoleculeBondsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BiostrucGraph_interMoleculeBondsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Biostruc-graph_inter-molecule-bondsType"));
