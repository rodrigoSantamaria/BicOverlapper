/**
 * ID2SReplyGetSplitInfo_blobIdType.java
 *
...
public class ID2SReplyGetSplitInfo_blobIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2BlobIdType ID2BlobId;

    public ID2SReplyGetSplitInfo_blobIdType() {
    }
    ...
    /**
     * Gets the ID2BlobId value for this ID2SReplyGetSplitInfo_blobIdType.
     * 
     * @return ID2BlobId
     */
    ...
    /**
     * Sets the ID2BlobId value for this ID2SReplyGetSplitInfo_blobIdType.
     * 
     * @param ID2BlobId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SReplyGetSplitInfo_blobIdType)) return false;
        ID2SReplyGetSplitInfo_blobIdType other = (ID2SReplyGetSplitInfo_blobIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SReplyGetSplitInfo_blobIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Reply-Get-Split-Info_blob-idType"));
