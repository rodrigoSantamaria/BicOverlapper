...
public class Tfoot  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootAlign align;  // attribute

    private java.lang.String _char;  // attribute

    private java.lang.String charoff;  // attribute

    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootValign valign;  // attribute
    ...
    public Tfoot(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootAlign align,
           java.lang.String _char,
           java.lang.String charoff,
           gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootValign valign) {
           this.tr = tr;
    ...
    /**
     * Gets the tr value for this Tfoot.
     * 
     * @return tr
     */
    ...
    /**
     * Sets the tr value for this Tfoot.
     * 
     * @param tr
     */
    ...
    /**
     * Gets the alternateFormOf value for this Tfoot.
     * 
    ...
    /**
     * Sets the alternateFormOf value for this Tfoot.
     * 
    ...
    /**
     * Gets the contentType value for this Tfoot.
     * 
     * @return contentType
     */
    ...
    /**
     * Sets the contentType value for this Tfoot.
     * 
     * @param contentType
     */
    ...
    /**
     * Gets the id value for this Tfoot.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this Tfoot.
     * 
     * @param id
     */
    ...
    /**
     * Gets the align value for this Tfoot.
     * 
     * @return align
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootAlign getAlign() {
        return align;
    }


    /**
     * Sets the align value for this Tfoot.
     * 
     * @param align
     */
    public void setAlign(gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootAlign align) {
        this.align = align;
    }


    /**
     * Gets the _char value for this Tfoot.
     * 
     * @return _char
     */
    ...
    /**
     * Sets the _char value for this Tfoot.
     * 
     * @param _char
     */
    ...
    /**
     * Gets the charoff value for this Tfoot.
     * 
     * @return charoff
     */
    ...
    /**
     * Sets the charoff value for this Tfoot.
     * 
     * @param charoff
     */
    ...
    /**
     * Gets the valign value for this Tfoot.
     * 
     * @return valign
     */
    public gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootValign getValign() {
        return valign;
    }


    /**
     * Sets the valign value for this Tfoot.
     * 
     * @param valign
     */
    public void setValign(gov.nih.nlm.ncbi.www.soap.eutils.efetch.TfootValign valign) {
        this.valign = valign;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">tfoot"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>tfoot>align"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", ">>tfoot>valign"));
        typeDesc.addFieldDesc(attrField);
