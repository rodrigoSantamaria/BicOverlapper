...
public class PackedSeg_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public PackedSeg_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this PackedSeg_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this PackedSeg_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PackedSeg_idsType)) return false;
        PackedSeg_idsType other = (PackedSeg_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PackedSeg_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Packed-seg_idsType"));
