...
public class ID2SChunkData_annotsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqAnnotType[] seqAnnot;

    public ID2SChunkData_annotsType() {
    }
    ...
    /**
     * Gets the seqAnnot value for this ID2SChunkData_annotsType.
     * 
     * @return seqAnnot
     */
    ...
    /**
     * Sets the seqAnnot value for this ID2SChunkData_annotsType.
     * 
     * @param seqAnnot
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SChunkData_annotsType)) return false;
        ID2SChunkData_annotsType other = (ID2SChunkData_annotsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SChunkData_annotsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Chunk-Data_annotsType"));
