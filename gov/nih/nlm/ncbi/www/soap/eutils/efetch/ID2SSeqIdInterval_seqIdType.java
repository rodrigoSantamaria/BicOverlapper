/**
 * ID2SSeqIdInterval_seqIdType.java
 *
...
public class ID2SSeqIdInterval_seqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID2SSeqIdInterval_seqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2SSeqIdInterval_seqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2SSeqIdInterval_seqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SSeqIdInterval_seqIdType)) return false;
        ID2SSeqIdInterval_seqIdType other = (ID2SSeqIdInterval_seqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SSeqIdInterval_seqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Seq-id-Interval_seq-idType"));
