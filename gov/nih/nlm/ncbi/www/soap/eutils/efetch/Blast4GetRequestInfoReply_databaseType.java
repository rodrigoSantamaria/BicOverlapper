/**
 * Blast4GetRequestInfoReply_databaseType.java
 *
...
public class Blast4GetRequestInfoReply_databaseType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4DatabaseType blast4Database;

    public Blast4GetRequestInfoReply_databaseType() {
    }
    ...
    /**
     * Gets the blast4Database value for this Blast4GetRequestInfoReply_databaseType.
     * 
    ...
    /**
     * Sets the blast4Database value for this Blast4GetRequestInfoReply_databaseType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4GetRequestInfoReply_databaseType)) return false;
        Blast4GetRequestInfoReply_databaseType other = (Blast4GetRequestInfoReply_databaseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4GetRequestInfoReply_databaseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-get-request-info-reply_databaseType"));
