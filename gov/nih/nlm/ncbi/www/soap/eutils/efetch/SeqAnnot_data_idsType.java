...
public class SeqAnnot_data_idsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType[] seqId;

    public SeqAnnot_data_idsType() {
    }
    ...
    /**
     * Gets the seqId value for this SeqAnnot_data_idsType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this SeqAnnot_data_idsType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeqAnnot_data_idsType)) return false;
        SeqAnnot_data_idsType other = (SeqAnnot_data_idsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeqAnnot_data_idsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seq-annot_data_idsType"));
