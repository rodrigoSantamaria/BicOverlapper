/**
 * ID2SChunkData_id_seqIdType.java
 *
...
public class ID2SChunkData_id_seqIdType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.SeqIdType seqId;

    public ID2SChunkData_id_seqIdType() {
    }
    ...
    /**
     * Gets the seqId value for this ID2SChunkData_id_seqIdType.
     * 
     * @return seqId
     */
    ...
    /**
     * Sets the seqId value for this ID2SChunkData_id_seqIdType.
     * 
     * @param seqId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2SChunkData_id_seqIdType)) return false;
        ID2SChunkData_id_seqIdType other = (ID2SChunkData_id_seqIdType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2SChunkData_id_seqIdType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2S-Chunk-Data_id_seq-idType"));
