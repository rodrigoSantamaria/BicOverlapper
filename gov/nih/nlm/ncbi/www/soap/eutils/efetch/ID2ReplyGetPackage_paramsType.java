/**
 * ID2ReplyGetPackage_paramsType.java
 *
...
public class ID2ReplyGetPackage_paramsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ID2ParamsType ID2Params;

    public ID2ReplyGetPackage_paramsType() {
    }
    ...
    /**
     * Gets the ID2Params value for this ID2ReplyGetPackage_paramsType.
     * 
     * @return ID2Params
     */
    ...
    /**
     * Sets the ID2Params value for this ID2ReplyGetPackage_paramsType.
     * 
     * @param ID2Params
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID2ReplyGetPackage_paramsType)) return false;
        ID2ReplyGetPackage_paramsType other = (ID2ReplyGetPackage_paramsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID2ReplyGetPackage_paramsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "ID2-Reply-Get-Package_paramsType"));
