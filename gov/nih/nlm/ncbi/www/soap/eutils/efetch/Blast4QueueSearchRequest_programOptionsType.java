/**
 * Blast4QueueSearchRequest_programOptionsType.java
 *
...
public class Blast4QueueSearchRequest_programOptionsType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.Blast4ParametersType blast4Parameters;

    public Blast4QueueSearchRequest_programOptionsType() {
    }
    ...
    /**
     * Gets the blast4Parameters value for this Blast4QueueSearchRequest_programOptionsType.
     * 
    ...
    /**
     * Sets the blast4Parameters value for this Blast4QueueSearchRequest_programOptionsType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Blast4QueueSearchRequest_programOptionsType)) return false;
        Blast4QueueSearchRequest_programOptionsType other = (Blast4QueueSearchRequest_programOptionsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Blast4QueueSearchRequest_programOptionsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Blast4-queue-search-request_program-optionsType"));
