/**
 * ChemGraphAlignment_domainType.java
 *
...
public class ChemGraphAlignment_domainType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.ChemGraphPntrsType[] chemGraphPntrs;

    public ChemGraphAlignment_domainType() {
    }
    ...
    /**
     * Gets the chemGraphPntrs value for this ChemGraphAlignment_domainType.
     * 
    ...
    /**
     * Sets the chemGraphPntrs value for this ChemGraphAlignment_domainType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChemGraphAlignment_domainType)) return false;
        ChemGraphAlignment_domainType other = (ChemGraphAlignment_domainType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChemGraphAlignment_domainType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Chem-graph-alignment_domainType"));
