...
public class Seqdesc_orgType  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.www.soap.eutils.efetch.OrgRefType orgRef;

    public Seqdesc_orgType() {
    }
    ...
    /**
     * Gets the orgRef value for this Seqdesc_orgType.
     * 
     * @return orgRef
     */
    ...
    /**
     * Sets the orgRef value for this Seqdesc_orgType.
     * 
     * @param orgRef
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Seqdesc_orgType)) return false;
        Seqdesc_orgType other = (Seqdesc_orgType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Seqdesc_orgType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/efetch", "Seqdesc_orgType"));
