...
public class LinkSetType  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.elink.IdListType idList;
    ...
    public LinkSetType(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.elink.IdListType idList,
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "IdListType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
