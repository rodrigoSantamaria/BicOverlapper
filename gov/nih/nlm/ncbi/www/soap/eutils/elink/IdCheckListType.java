...
public class IdCheckListType  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.www.soap.eutils.elink.IdLinkSetType idLinkSet;
    ...
    public IdCheckListType(
           ...
           gov.nih.nlm.ncbi.www.soap.eutils.elink.IdLinkSetType idLinkSet,
     ...
     * @param idLinkSet
     */
    public void setIdLinkSet(gov.nih.nlm.ncbi.www.soap.eutils.elink.IdLinkSetType idLinkSet) {
        this.idLinkSet = idLinkSet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.idLinkSet==null && other.getIdLinkSet()==null) || 
             (this.idLinkSet!=null &&
              this.idLinkSet.equals(other.getIdLinkSet()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getIdLinkSet() != null) {
            _hashCode += getIdLinkSet().hashCode();
        }
        if (getERROR() != null) {
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "IdLinkSetType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
